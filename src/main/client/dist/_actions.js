...
import { isLogged, render, sortableGrid, validateEmail, contextPath } from "./utils";
...
export function nextImagePage(e) {
    ...
    // @ts-ignore
    var imageGrid = __spread(DOM.imageGridContainer.children).find(function (child) { return !child.classList.contains('hidden'); });
    if (imageGrid !== undefined) {
        __spread(imageGrid.children).forEach(function (image, index) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    imageGridRetrieved = __spread(DOM.imageGridContainer.children).find(function (child) { return child.dataset.album == albumId; });
                    if (imageGridRetrieved !== undefined) {
                        ...
                        // @ts-ignore
                        __spread(DOM.imageGridContainer.children).forEach(function (child) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    image_1 = _b.sent();
                    imageGrid_1 = __spread(DOM.imageGridContainer.children).find(function (child) { return child.dataset.album == image_1.albumId; });
                    ...
                    if (imageGrid_1.childElementCount > 5) {
                        ...
                        DOM.nextButton.dataset.index = "5";
                        // @ts-ignore
                        __spread(imageGrid_1.children).forEach(function (child, index) {
                            if (index > 4)
...
export function retrieveAlbums() {
    return __awaiter(this, void 0, void 0, function () {
        var response, albums, albumCollection, albumCollection_1, albumCollection_1_1, album, error, e_6;
        var e_7, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 3:
                    ...
                    if (Array.isArray(albumCollection)) {
                        try {
                            for (albumCollection_1 = __values(albumCollection), albumCollection_1_1 = albumCollection_1.next(); !albumCollection_1_1.done; albumCollection_1_1 = albumCollection_1.next()) {
                                album = albumCollection_1_1.value;
                            ...
                            try {
                                if (albumCollection_1_1 && !albumCollection_1_1.done && (_a = albumCollection_1.return)) _a.call(albumCollection_1);
                            }
...
export function updateOrder() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b, album, body, response, error, success, e_8, e_9_1;
        var e_9, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _d.trys.push([0, 10, 11, 12]);
                    _a = __values(DOM.albumGrid.children), _b = _a.next();
                    _d.label = 1;
                case 1:
...
export function addAlbum(e) {
    return __awaiter(this, void 0, void 0, function () {
        var body, response, _a, album, albumElement, error, e_10;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    e.preventDefault();
